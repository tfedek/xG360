...
function buildPart4() {
  return [
    ...
    p('Napomena o Likelihood Ratio testu: LR test je primenjen isključivo na neponderisanom, nepenalizovanom logističkom modelu (bez class_weight i bez regularizacije), jer ponderisanje klasa menja efektivnu likelihood funkciju. Prediktivni modeli koriste se za Brier/AUC izveštavanje; inferencijalni model služi isključivo za formalni test značajnosti.'),
